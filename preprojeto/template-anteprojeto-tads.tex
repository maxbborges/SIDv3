...
\section*{Revisão da Literatura}
	...
	Atualmente, uma solução encontrada que faz integração entre as redes sociais e ao conceito de sinalização digital é o software da OOZO, usando o kit Raspberry Pi, na sua versão mais completa é possível espelhar comentários das redes sociais e criar um filtro de hastag das redes sociais. Entretanto, todo o conteúdo é exibido apenas em telas, sendo possível apenas a pré-visualização em browsers \cite{Oozo2017}.
	
	Outra solução encontrada é a MangoSigns, ela possui integração com as redes sociais, atualidades, informações do tempo, interface amigável entre outras funcionalidades. Entretanto, é necessário um dispositivo próprio chamado Mango Sing Box para que as informações feitas na interface do programa sejam transmitidas para a TV \cite{Mango2017}.
