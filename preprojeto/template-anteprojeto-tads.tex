...
\section*{Revisão da Literatura}
	...
	\cite{santos2014} comenta que em um primeiro momento as \daniel{estrategias}{estratégias} de mercado \daniel{era}{eram} \daniel{voltada}{voltadas} para meios tradicionais como TV, rádio, jornais, revistas e outros. Com a popularização da internet foi necessário buscar outros meios de marketing, chegando ao marketing digital que é o uso das mídias sociais para exposição dos produtos.
	...
	\danielobs{Evite usar citação direta, parafraseie o que o autor disse. Reescreva o parágrafo acima}
	
	\subsection*{Trabalhos Relacionados}
	Atualmente, uma solução encontrada \daniel{}{na literatura} que faz integração entre marketing digital e \daniel{ao}{o} conceito de sinalização digital é o software da OOZO, usando o kit Raspberry Pi. Na sua versão mais completa é possível espelhar comentários e até mesmo criar um filtro de hastag, além de possuir em cada tela um QR code de redirecionamento para o link da noticia completa. Entretanto, todo o conteúdo é exibido apenas em uma tela \daniel{publica}{pública}, sendo possível apenas a pré-visualização em \daniel{browsers}{}. Em sua versão gratuita, metade do conteúdo exibido será o seu e a outra parte será outras propagandas escolhidas pelos criados do software. \cite{oozo2017}.
	
	\danielobs{Palavras estrangeiras como browsers devem estar em itálico. Caso prefira, pode usar a equivalente em português, \textbf{navegador}, sem a necessidade do itálico.}	
	...
	O Screenly usa o Raspberry Pi e um software próprio \daniel{instalada}{instalado} no equipamento para seu funcionamento. Além de não possuir nenhum tipo de integração social ou QR code, sua versão gratuita oferece uma tela publica e somente 2 propagandas. Na sua versão mais cara oferece até 130 telas publicas, havendo a possibilidade de incluir telas extras \cite{screenly2017}.
	
	\danielobs{Não está claro pro leitor o que é uma tela pública.}
	
	\danielobs{Pública tem acento. Conserte no restante do texto.}
	...
	\danielobs{Preencha a tabela, quais os quesitos de comparação?}
...
\subsection*{Objetivos Gerais}
	Com objetivo de diminuição da carência e aumento da facilidade de disseminação das informações e propagandas pertinentes ao IFB - Campus Taguatinga, o sistema deverá ser capaz de proporcionar objetividade e simplicidade nas informações a serem repassadas. Além de painéis instalados pelo campus, ele deve ter a integração com as mídias sociais como Facebook e Twitter, unificando os sistemas de comunicação do IFB.
	
	\danielobs{Comentar aqui que a integração não é uma simples otimização de API. Técnicas de mineração de dados devem ser utilizadas para selecionar conteúdo apropriado a ser inserido.}

\subsection*{Objetivos Específicos}
	Melhorias do sistema usado como base, o SID \cite{sobrinho2017}.
	
	Melhoria na integração do sistema com o Facebook.
	
	Integrar o sistema com outras mídias sociais como o twitter.
	
	\danielobs{Implementar uma versão mobile do sistema para consulta em smartphones de modo a tornar cada dispositivo mobile dos transeuntes em um cliente.}
\section*{Metodologia}
