...
var intervaloRequisicao=10000;

$(document).ready(function(){

	// Define o intervalo de atualização dos comentarios/publicaçoes (Mude a valor de intervaloRequisicao)
	setInterval(function(){
		$.ajax({
			...
			success: function(dados){
				...
				// Define o intervalo de troca das postagens (Mude intervaloPublicacoes)
