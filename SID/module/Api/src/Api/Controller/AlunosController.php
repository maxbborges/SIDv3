...
class AlunosController extends AbstractRestfulController
{
  ...
  public function create($data){
    require_once 'public/Connection.php';
    $sql = "insert into aluno values ('".$data['nome']."','".$data['matricula']."',md5('".$data['senha']."'));";
    $res = pg_query($sql);
  ...
  public function update($id, $data){
    require_once 'public/Connection.php';
    $sql = "update aluno SET nome = '".$data['nome']."', senha = md5('".$data['senha']."') where matricula = '".$id."';";
    $res = pg_exec($conn,$sql);
