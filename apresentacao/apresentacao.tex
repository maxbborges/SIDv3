...
\begin{figure}[h]
	...
	\subfloat[oozo]{
    	\includegraphics[height=2cm]{figuras/oozo.png}
    	\label{fig03a}
  	}
  	\quad %espaco separador
  	\subfloat[Mango Signs]{
    	\includegraphics[height=2cm]{figuras/mango.png}
    	\label{fig3b}
  	}
  	\quad %espaco separador
  	\vspace{10px}
 	\subfloat[Xibo]{
    	\includegraphics[height=2cm]{figuras/xibo.png}
    	\label{fig3b}
  	}
    \quad %espaco separador
  	\subfloat[Screenly]{
    	\includegraphics[height=2cm]{figuras/screenly.png}
    	\label{fig3b}
  	}
\label{fig1}
\end{figure}
